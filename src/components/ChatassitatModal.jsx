...
const ChatassitatModal = ({ open, handleClose }) => {
  return (
    <ReadProfileBox>
      <Box className="chatdialogBox">
        ...
        >
          ...
          <Box className="chatscrollBox">
            ...
            >
              <Box align="center" className="chatcontentmainBox">
                <Avatar
            ...
            <DialogContent className="gradientTextborder">
              <Box className="gradientbackground ">
                ...
                <Box className="msg">
                  <Box className="msg left-msg">
                    <Box className="profilechatImg displayCenter">
                      <img src="/images/chatprofile.svg" alt="images" />
                    </Box>
                ...
                <Box align="center">
                  <img src="images/music.png" alt="images" />
                </Box>
          ...
          <Box className="displaySpacebetween bottomTextfeild">
            ...
            <IconButton className="chatIconBox">
              <img src="/images/voice.svg" alt="voice" />
            </IconButton>
            <IconButton style={{ background: "transparent" }}>
              <img src="/images/chatarrow.svg" alt="voice" />
            </IconButton>
...
export default ChatassitatModal;
